                ...
                switch (stageIndex) {
                    case 0: // 1번째 스테이지
                        SwingUtilities.invokeLater(() -> {
                             ...
                             Card cardPanel = new Card(cardFrame); // 게임 패널
                    ...
                    case 1:
                        SwingUtilities.invokeLater(() -> {
                            ...
                            Clover cloverPanel = new Clover(cloverFrame);
                    ...
                    case 2: // 3번째 스테이지
                        SwingUtilities.invokeLater(() -> {
                            ...
                            Puzzle puzzlePanel = new Puzzle(puzzleFrame);
                    ...
                    case 3: // 4번째 스테이지
                        SwingUtilities.invokeLater(() -> {
                         ...
                         // startCoinGame이 Cat 객체를 반환한다고 가정
                            Cat bonusPanel = new Cat().startCoinGame(bonusFrame, bonusFrame);  // bonusFrame을 전달하고, Cat 객체를 반환 받음
                    ...
                    case 5: // 6번째 스테이지
                        SwingUtilities.invokeLater(() -> {
                            ...
                            Arrow arrowPanel = new Arrow(arrowFrame); // Arrow 클래스의 게임 화면을 추가
